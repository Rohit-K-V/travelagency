    ...
    vehicle assigned successfully <a href="asignorunasignvc.html" class="alert-link">BACK</a>. Give it a click if you like.
  </div>';
            } else {
                $con->error;
            }
...
<body>
    ...
    <div class="mb-3">
        ...
        <input type="text"name="vid" class="form-control" id="formGroupExampleInput2" placeholder="enter vehicle-id" required><br>
